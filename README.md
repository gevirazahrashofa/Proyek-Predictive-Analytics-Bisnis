...
Kesimpulan keseluruhan : Model Gradient Boosting Regressor terbukti paling akurat dalam memprediksi harga sewa rumah, mengungguli Random Forest dan Linear Regression. Fitur seperti ukuran rumah dan jumlah kamar mandi memiliki pengaruh besar terhadap harga. Dengan pemilihan model yang tepat dan optimasi hyperparameter, prediksi harga sewa bisa dilakukan secara efektif dan andal.
